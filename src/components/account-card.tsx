  ...
  return (
    <TooltipProvider>
      {/* h-full：撑满栅格行高。配合父级 grid 的 auto-rows-fr，让同一排的卡片
          ...
          底部操作栏因此始终对齐）。 */}
      <article className="flex h-full min-w-0 flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-[0_1px_2px_rgba(15,23,42,.025),0_10px_28px_rgba(15,23,42,.035)] transition-shadow hover:shadow-[0_2px_4px_rgba(15,23,42,.04),0_14px_34px_rgba(15,23,42,.055)]" data-slot="account-card">
      <header
        className={cn(
