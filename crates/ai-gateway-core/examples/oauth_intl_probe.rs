...
//!
//! 运行：
//!   cargo run -p ai-gateway-core --example oauth_intl_probe
//!   # 自定义轮询窗口（秒），默认 1800
//!   $env:AI_GATEWAY_PROBE_TIMEOUT_SEC = "3600"; cargo run -p ai-gateway-core --example oauth_intl_probe
//!
...
use ai_gateway_core::modules::config::{http_request, Region, WORKBUDDY_API_PREFIX};

const POLL_INTERVAL: Duration = Duration::from_secs(2);
const DEFAULT_TIMEOUT_SEC: u64 = 1800;

fn probe_timeout() -> Duration {
    let secs = std::env::var("AI_GATEWAY_PROBE_TIMEOUT_SEC")
        .ok()
