...
/// 导出文件名白名单：只允许 `ai-gateway-accounts-YYYY-MM-DD.json` 这类由前端生成的文件名。
...
mod tests {
    ...
    fn export_file_name_rejects_traversal_and_non_json() {
        ...
        assert!(validate_export_file_name("ai-gateway-accounts-2026-08-21.json").is_ok());
    }
