...
#   arch: aarch64 | x64
#   .app 路径默认 target/release/bundle/macos/ai-gateway.app
...
V=$1
ARCH=$2
APP=${3:-target/release/bundle/macos/ai-gateway.app}
...
OUT="ai-gateway_${V}_${ARCH}.dmg"
TMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/ai-gateway-dmg.XXXXXX")
TMP_OUT="$TMP_DIR/$OUT"
